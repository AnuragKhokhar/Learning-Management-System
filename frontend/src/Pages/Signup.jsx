...
function Signup(){
    ...
    async function createNewAccount(event){
        ...
        if(!signupData.password.match(/^(?=.*[0-9])(?=.*[!@#$%^&*])[a-zA-Z0-9!@#$%^&*]{6,16}$/)){
            toast.error("Password should be 0-16 character long with atleast a number and special character")
            return;
        }
        ...
        <HomeLayout>
            <div className='flex items-center justify-center h-[100vh] ' >
                <form noValidate onSubmit={createNewAccount} className='flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-96 shadow-[0_0_10px_black]' >
                    ...
                    name='image_uploads'
                    id='image_uploads' accept='.jpg, .jpeg, .png, .svg' />
                    ...
                    <button type = 'submit' className=' mt-2 bg-yellow-600 hover:bg-yellow-500 transition-all ease-in-out duration-300 rounded-sm py-2 font-semibold text-lg ' >Create Account</button>
